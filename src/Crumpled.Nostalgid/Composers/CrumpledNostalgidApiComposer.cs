...
namespace Crumpled.Nostalgid.Composers
{
    public class CrumpledNostalgidApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "CrumpledNostalgid Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<CrumpledNostalgidOperationSecurityFilter>();
            });
        }

        public class CrumpledNostalgidOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Crumpled.Nostalgid.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
